...
async function startServer() {
  ...
  registerSpotifyPlaylistRoutes(app);
  app.post("/api/scheduled/anniversary-web-push", handleScheduledAnniversaryWebPush);
  app.post("/api/scheduled/notification-web-push", handleScheduledContentWebPush);
  app.post("/api/scheduled/music-web-push", handleScheduledMusicWebPush);
  // tRPC API
  app.use(
    "/api/trpc",
